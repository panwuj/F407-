...
/*******************************************************************************
* Function Name  : void matrix_transpose(float* A, int m, int n, float* C) 
* Description    : 矩阵求转置
* Input          : None
* Output         : None
* Return         : None
...
/*******************************************************************************
* Function Name  : int matrix_inversion(float* A, int n, float* AInverse) 
* Description    : 矩阵求逆
* Input          : None
* Output         : None
* Return         : None
...
/*******************************************************************************
* Function Name  : void matrix_multiply(float* A, float* B, int m, int p, int n, float* C) 
* Description    : 两个矩阵相乘
* Input          : None
* Output         : None
* Return         : None
...
/*******************************************************************************
* Function Name  :void matrix_addition(float* A, float* B, int m, int n, float* C) 
* Description    : 两个矩阵相加
* Input          : None
* Output         : None
* Return         : None
...
/*******************************************************************************
* Function Name  :void matrix_subtraction(float* A, float* B, int m, int n, float* C) 
* Description    : 两个矩阵相减
* Input          : None
* Output         : None
* Return         : None
